...
<head>
    ...
    <title>pré-inscription FI</title>
...
<body>
    ...
    <main class="container" style="margin-top: 70px;">
        ...
        <div class="card mt-5">
            ...
            <div class="card-body">
                <form action="../controllers/choix_fi.php" method="post">
                    <div class="mt-3">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-12 mt-3">
                            <input type="submit" value="Enregistrer" name="choix_fi_enr" class="form-control btn btn-success" >
                        </div>
                    </div>
                </form>
            </div>
